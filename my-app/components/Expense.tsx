...
export default function Expense({expense}:any) {
  const total = expense.reduce((acc: number, exp: any) => acc + Number(exp.amount), 0);
    ...
    <div>
       <div className="flex flex-col items-center">
          ...
          <div className="text-center">
            <p className="text-2xl font-semibold text-gray-400 mt-2">Expense</p>
